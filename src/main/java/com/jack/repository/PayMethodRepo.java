...
public interface PayMethodRepo extends JpaRepository<PayMethod, Long>
{
	...
	public List<PayMethod> findAllByUserUserId(String userId);
	 ...
	 */
	public Optional<PayMethod> findByUserUserIdAndPmId(String userId, long pmId);

	/*
		Find Pay Method by this name under this user
	 */
	public Optional<PayMethod> findByUserUserIdAndPayMethodName(String payMethodName, String userId);

...
@Repository
public interface SimpleTransactionRepo extends JpaRepository<SimpleTransaction, Long>
{
	...
	public List<SimpleTransaction> findAllByOrderByPurchaseDateDesc();
	...
	public List<SimpleTransaction> findAllByOrderByPurchaseDateDescPageable( @Param("total") Integer total, @Param("offset") Integer offset);
